> [!IMPORTANT]
> You may be looking for my Nix config repository.
> My Nix/NixOS configs can now be found at [`pgattic/nixconf`](https://github.com/pgattic/nixconf).
> This repository is kept for historical purposes (or for if I ever actually need to use traditional dotfiles), and will probably not be kept up to date.
